...
window.LOVE_SITE_DATA = {
  assetVersion: "20260706-final-voice-demo",
  secretDate: "21102021",
  couple: {
    yourName: "Chinnu",
  ...
  promises: [
    ...
    "I promise to listen to your silence with the same care I give your words.",
    "I promise to make your happiness feel important, never ordinary.",
    "I promise to hold your hand through fear, confusion, waiting, and every difficult tomorrow.",
    "I promise to respect your heart, your choices, your dreams, and the person you are becoming.",
    "I promise to never let my ego become bigger than my love for you.",
    "I promise to apologize when I hurt you and grow from every mistake I make.",
    "I promise to make you feel chosen, not just loved.",
    "I promise to be proud of you in public and gentle with you in private.",
    "I promise to pray for your peace, your health, your success, and our future.",
    "I promise to keep your trust safe like one of the most precious gifts of my life.",
    "I promise to love you in the small daily ways, not only in big romantic moments.",
    "I promise to notice the tiredness behind your smile and care for you softly.",
    "I promise to remind you that you are enough, even on the days you feel weak.",
    "I promise to support your NEET PG journey with patience, pride, and endless belief.",
    "I promise to never compare you with anyone, because my heart recognizes only you.",
    "I promise to make our love feel like home, not pressure.",
    "I promise to keep choosing honesty, even when a conversation feels difficult.",
    "I promise to protect the little world we are building together.",
    "I promise to be the person you can come back to without fear.",
    "I promise to celebrate your dreams before they come true and after they become real.",
    "I promise to love your soft side, your strong side, and every side in between.",
    "I promise to never stop finding new reasons to admire you.",
    "I promise to stand with you when life feels unfair.",
    "I promise to make time for you, because love should never feel like leftover attention.",
    "I promise to remember the little things that matter to your heart.",
    "I promise to protect your smile whenever life tries to steal it.",
    "I promise to speak to you with kindness, even when emotions are high.",
    "I promise to keep our memories alive and keep making new ones with you.",
    "I promise to love you in a way that gives you peace, not doubt.",
    "I promise to be patient with your stress and gentle with your worries.",
    "I promise to keep believing in us, even during seasons that test us.",
    "I promise to make you feel beautiful in more ways than appearance.",
    "I promise to care for your heart like it is connected to mine, because it is.",
    "I promise to never treat your love casually.",
    "I promise to be grateful for you in ordinary mornings and special nights.",
    "I promise to keep our bond protected from pride, distance, and misunderstanding.",
    "I promise to be your biggest supporter when you doubt your own strength.",
    "I promise to keep loving you with effort, loyalty, respect, and warmth.",
    "I promise to make our future feel like something we build together, not something you carry alone.",
    "I promise to be there in your success, your stress, your silence, and your laughter.",
    "I promise to keep my heart loyal to the life I imagine with you.",
    "I promise to love you not only for who you are today, but for every version of you tomorrow."
  ],
  reasons: [
  ...
  birthday: {
    ...
    finalVoiceNote: {
      ...
      file: "assets/final-voice-note/Demo Final Voice Note.wav",
      replaceHint: "Demo voice note. Replace this file with your real final voice when you are ready."
    },
    proposalFlow: {
